...
info_dict = yaml.load(Bag(os.path.expanduser(f"~/pyvkdepth/rosbag/5_scene2_crackerParmesansoupMayoSaladDressing1_CPSa.bag"))._get_yaml_info(), Loader=yaml.FullLoader)
