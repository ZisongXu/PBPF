...
2. **Update the Physical Simulation Environment**
	...
	Modify the environment configuration (6D poses only) in `./PBPF/home/catkin_ws/src/PBPF/scripts/Create_Scene.py`, and then load the physics simulation environment in `./PBPF/home/catkin_ws/src/PBPF/scripts/SingleENV.py`.
